    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4" data-testid="login-page">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-['Manrope']">Welcome back</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-center text-sm text-slate-500">
            <Link to="/forgot-password" className="text-primary hover:underline font-medium" data-testid="forgot-password-link">
